...
albumin_res(:,exc_ind) = [];
writematrix(albumin_res','vitaminD_vs_aveBV_for_GAMM.csv');
...
gamm_res = readmatrix('VD_fitted_GAMM_curve_for_ft.csv');
...
gamm_res = readmatrix('VD_fitted_GAMM_curve_for_Pt.csv');
gamm_res(:,4) =gamm_res(:,4);
gamm_res(:,5) =gamm_res(:,5);
...
xlabel('Vitamin D (ng/ml)')

set(findall(gcf,'-property','fontweight'),'fontweight','bold');
set(findall(gcf,'-property','fontsize'),'fontsize',14);
title('Vitamin D','fontsize',16)
